...
export default function UninstallPage() {
  ...
  return (
    <div>
      ...
      {submitted ? (
        <h1 className="mt-12 text-xl font-semibold text-gray-900">Thank you for your feedback!</h1>
      ) : (
        <>
          ...
          <p className="mt-2 text-sm text-gray-700">
            Your feedback is important and it&apos;s critical we understand how SVG Gobbler
            didn&apos;t meet your needs. <i>Include your email if you want us to follow up.</i>
          </p>
          ...
          <form data-netlify="true" method="POST" name="uninstall" netlify-honeypot="bot-field">
            ...
            />
            <Button className="mt-4 w-full" color="red" onClick={handleSubmit} type="submit">
              Submit feedback
            </Button>
          </form>
        </>
