...
function SwirlyDoodle(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg aria-hidden="true" preserveAspectRatio="none" viewBox="0 0 281 40" {...props}>
      <path
        clipRule="evenodd"
...
export function Pricing() {
  return (
    <section aria-label="Pricing" className="bg-slate-900 py-20 sm:py-32" id="pricing">
      <Container>
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              <SwirlyDoodle className="absolute left-0 top-1/2 h-[1em] w-full fill-red-400" />
